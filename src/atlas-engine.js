import { TEXT_SIGNAL_TEMPLATES, validTextSignal } from './text-signals.js';
...
export const DEFAULT_ATLAS_VIEW = {
  ...
  lens: 'default',
  scale: 'default',
  frame: { mode: 'natural', signal: 'semantic', reference: '', geometry: 'semantic', categoryPull: .78, localCohesion: .26, sensitivity: .58, unclaimedThreshold: .34, appearance: { colorBy: 'category', sizeBy: 'file', terrain: 'density', regions: true }, categories: [] },
};

export const ATLAS_VIEW_TEMPLATES = {
  natural: { name: 'Natural landscape', signal: 'semantic', description: 'Let the vault form its own semantic neighborhoods.', categories: [] },
