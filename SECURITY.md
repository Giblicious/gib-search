...
Before reporting an unexpected network request, note that first-run setup downloads the pinned runtime from npm and BGE Small English v1.5 from Hugging Face.
