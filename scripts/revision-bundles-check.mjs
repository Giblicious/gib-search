...
if (!searchResultRenderer.includes("cls: 'gib-revision-count', text: `${result.revisionCount} editions`") || !searchResultRenderer.includes("cls: 'gib-revision-actions'") || !searchResultRenderer.includes("text: 'Show versions'") || !searchResultRenderer.includes("'aria-expanded': 'false'") || searchResultRenderer.includes("cls: 'gib-revision-bundle'") || searchResultRenderer.includes("createEl('time'") || !stylesSource.includes('.gib-revision-actions{display:flex;flex:none;align-items:center;gap:2px;margin-left:auto}')) throw new Error('Vault-search edition count and title-only version controls are not positioned on the directory metadata row');
