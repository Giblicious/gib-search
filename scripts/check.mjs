...
if (!mainSource.includes('collisionDistance = .035') || !mainSource.includes('edge.strength * .009')) throw new Error('Size-aware collision or similarity springs are missing');
