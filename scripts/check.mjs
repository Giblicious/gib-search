...
if (!mainSource.includes('], 220)') || !mainSource.includes('length: 24')) throw new Error('High-resolution contours or unclipped perimeter constraints are missing');
