...
if (!mainSource.includes('a.matched !== b.matched') || !mainSource.includes("ctx.filter = isBackground ? `blur(") || !mainSource.includes('this.cameraZoom') || !mainSource.includes('this.parallaxX')) throw new Error('Foreground isolation, depth blur, zoom, or parallax is missing');
